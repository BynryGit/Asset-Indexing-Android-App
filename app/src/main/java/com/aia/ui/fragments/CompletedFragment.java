 ...
 */
public class CompletedFragment extends ParentFragment
{
            ...
            Bundle savedInstanceState)
    {
        ...
        recyclerView = (RecyclerView)rootView.findViewById(R.id.recycler_view_completed);
        layoutManager = new LinearLayoutManager(getActivity().getApplicationContext());
        recyclerView.setLayoutManager(layoutManager);
        TodayAdapter completedAdapter = new TodayAdapter(mContext, screenName, null);
